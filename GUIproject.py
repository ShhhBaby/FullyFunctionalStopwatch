...
class App():
    ...
    def __init__(self):
        self.root = Tk()
        self.root.title("Varun's Stop Watch")
        self.root.geometry("600x500")
        self.root.resizable(False, False)

        self.t = StringVar()
        self.t.set("00:00:00")
        self.lab = Label(self.root, text = "Made by Varun KJ..", font = ("Italics 15 bold"))
        ...
        self.lb.place(x=160, y=200)
        self.bt1.place(x=130, y=400)
        self.bt2.place(x=255, y=400)
        self.bt3.place(x=370, y=400)
        self.root.mainloop()
